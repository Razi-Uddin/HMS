...
<body style="padding-top:50px;">
  ...
  <div class="container-fluid" style="margin-top:50px;">
    ...
    <div class="row">
      <div class="col-md-12" style="display: flex; justify-content: center;">
        <form method="get" action="search-results.php" class="form-inline">
          <div class="form-group">
            <input type="text" class="form-control" id="searchInput" name="search_input" placeholder="Enter Doctor name | specialization | city" style="width: 400px;">
          </div>
          <button type="submit" class="btn btn-primary ml-2" name="search_submit">Search</button>
        </form>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4" style="max-width:25%; margin-top: 3%">
        <div class="list-group" id="list-tab" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="profile">View Profile</a>
    ...
    <div class="card">
        <div class="card-body">
            <?php
            // Check if user is logged in and retrieve patient profile based on session information
                ...
                <div class="card-body">
                  ...
                  <form class="form-group" method="post" action="admin-panel.php">
                    <div class="row">
                      ...
                      {
                        $con = mysqli_connect("localhost", "root", "", "myhmsdb");
                        $query = mysqli_query($con, "SELECT DISTINCT city FROM doctb");
  ...
  <script>
    ...
    function fetchDoctors(city) {
      var xhr = new XMLHttpRequest();
      xhr.open('GET', 'fetch_doctors.php?city=' + city, true);
      xhr.onload = function() {
        if (xhr.status == 200) {
    ...
    function updateDoctorList(doctors) {
      ...
      doctors.forEach(function(doctor) {
        ...
        option.dataset.value = doctor.docFees;
        option.dataset.spec = doctor.spec;
